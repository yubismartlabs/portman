...
import { Activity, ArrowUpDown, CircleStop, Copy, ExternalLink, Globe2, Grid2X2, List, Loader2, LockKeyhole, RefreshCw, Search, Server, ShieldAlert, ShieldCheck, TerminalSquare, X } from "lucide-react";
import type { BinaryTrust, Listener, ProcessMetrics } from "@/lib/types";
    ...
    <section className="workspace">
      <div className="workspace-content">
        ...
        <section className={`main-panes ${selected ? "with-inspector" : ""}`}>
          ...
          {selected && <Inspector listener={selected} metrics={metrics} history={metricHistory} onClose={() => setSelectedId(null)} onStop={setStopping} />}
        </section>
      </div>
      <footer className="statusbar"><span><i className="pulse"/> Native scanner online</span><span>TCP listeners only</span><span>Current user processes can be stopped</span></footer>
    </section>
